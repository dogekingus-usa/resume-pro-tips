...
$wt = 'C:\Users\SAMPC\resumeprotips-us-astro'
...
const jsonLd = {
  ...
  publisher: { '@type': 'Organization', name: 'ResumeProTips' },
};
---
...
foreach ($slug in $skipPages) {
  ...
  $m = $meta[$slug]
  if (-not $m) { $m = @{ title = $slug; desc = ''; canonical = "https://resumeprotips.com/$slug" } }
